...
import com.quantpower.spotquotes.model.NewsModel;
...
public class NewsActivity extends Activity {
    ...
    private void bindRecycleView() {
        this.myOrderReycAdapter = new RecyclerAdapter<NewsModel>(NewsActivity.this, myOrderReycList,
                R.layout.item_news) {
            @Override
        ...
        this.recyclerView.setLayoutManager(new GridLayoutManager(NewsActivity.this, 1,
...
//            UIHelper.startActivity(NewsActivity.this, NewsDetailActivity.class, bundle);
